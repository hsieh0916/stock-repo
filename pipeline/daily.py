...
def main():
    ...
    try:
        errs += backfill.backfill_00982a()
    except Exception as e:
        print(f"daily: 00982A backfill failed: {e}")
        errs += 1
    try:
        backfill.build_dataset_00982a()
    except Exception as e:
        print(f"daily: 00982A build_dataset failed: {e}")
    try:
        errs += backfill.backfill_00980a()
    except Exception as e:
        print(f"daily: 00980A backfill failed: {e}")
        errs += 1
    try:
        backfill.build_dataset_00980a()
    except Exception as e:
        print(f"daily: 00980A build_dataset failed: {e}")
    try:
        errs += backfill.backfill_00988a()
    except Exception as e:
        print(f"daily: 00988A backfill failed: {e}")
        errs += 1
    try:
        backfill.build_dataset_00988a()
    except Exception as e:
        print(f"daily: 00988A build_dataset failed: {e}")
    try:
        errs += backfill.backfill_00990a()
    except Exception as e:
        print(f"daily: 00990A backfill failed: {e}")
        errs += 1
    try:
        backfill.build_dataset_00990a()
    except Exception as e:
